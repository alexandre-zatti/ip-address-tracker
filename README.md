[![Tests](https://github.com/alexandre-zatti/ip-adress-tracker/actions/workflows/tests.yaml/badge.svg?branch=main)](https://github.com/alexandre-zatti/ip-adress-tracker/actions/workflows/tests.yaml)
